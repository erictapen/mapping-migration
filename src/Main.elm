        ...
        barElements =
            map (\f -> f ad.total population)
                [ barElement
                    ...
                    0
                    "recognized"
                    [ h1 [ infoboxH1Style ] [ text "Recognized asylum claims" ]
                ...
                , barElement
                    ...
                    "otherwise closed"
                    [ h1 [ infoboxH1Style ] [ text "Otherwise closed asylum claims" ]
                ...
                , barElement
                    ...
                    "rejected"
                    [ h1 [ infoboxH1Style ] [ text "Rejected asylum claims" ]
