...
"""
            , span [ style "font-style" "italic" ] [ text "refugee" ]
            , text """
with a person that has had to escape from his or her home to search and hopefully find a new place to live that offers safety, fair living conditions and new opportunities. The word evokes so many images of human bodies on the move, in camps, or in detention centers, it almost seems as if being a
"""
            , span [ style "font-style" "italic" ] [ text "refugee" ]
            , text """
were the natural state of a particular, homogenous group of people. As if this word were not a political one. But it is. Refugees are not simply
"""
            , span [ style "font-style" "italic" ] [ text "refugees," ]
            , text """
they are labelled as such (cf. Zetter 2007). Refugees are not born
"""
            , span [ style "font-style" "italic" ] [ text "refugees," ]
            , text """
...
"""
            , span [ style "font-style" "italic" ] [ text "refugee" ]
            , text """ 
officially. Before being recognized as a
"""
            , span [ style "font-style" "italic" ] [ text "refugee," ]
            , text """
...
""" ]
        , img [ title "number in category", src "/assets/hovering above a footprint.png" ] []
        , h2 []
...
"""
        ...
        , ul []
            ...
            , li []
                ...
                , br [] []
                , span [] [ text "Concept, Data Exploration, Programming, Text" ]
                ]
            , li []
            ...
            , li []
                ...
                , span [ style "font-style" "italic" ] [ text "MA Urbane Zukunft" ]
                , br [] []
                , span [] [ text "Concept, Data Exploration, Text" ]
                ]
            , li []
                ...
                , span [ style "font-style" "italic" ] [ text "MA Urbane Zukunft" ]
                , br [] []
                , span [] [ text "Concept, Data Exploration, Design, Text" ]
                ]
            ]
        , h2 []
